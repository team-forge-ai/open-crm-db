...
CREATE TABLE semantic_embeddings (
  ...
  embedding_provider text NOT NULL DEFAULT 'mlx',
  embedding_model text NOT NULL DEFAULT 'mlx-community/embeddinggemma-300m-4bit',
  embedding_model_version text NOT NULL DEFAULT '4bit',
